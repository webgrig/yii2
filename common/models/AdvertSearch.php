...
class AdvertSearch extends Advert
{
    ...
    {
        return [
            [['id', 'price', 'fk_agent', 'bedroom', 'livingroom', 'parking', 'kitchen', 'hot', 'sold', 'recomend', 'created_at', 'updated_at'], 'integer'],
            [['adrress', 'general_image', 'description', 'location', 'type'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'adrress', $this->adrress])
